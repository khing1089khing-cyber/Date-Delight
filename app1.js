...
const catalog = [
  { id:'date-powder', name:'Date Powder', pricing:'₹549', size:'200g / 500g jar', position:'Granulated sugar replacement', img:'DD_1.jpeg', tags:['festivals'] },
  { id:'choco-gift-dates', name:'Choco Dates', pricing:'₹1500', size:'9 / 18 pc gift box', position:'Luxury indulgence, gifting', img:'DD_2.jpeg', tags:['festivals','wedding','corporate'] },
  { id:'energy-bars', name:'Date & Nut Energy Bars', pricing:'₹450', size:'35–40g single / multipack', position:'Clean-label, no added sugar snack', img:'DD_3.jpeg', tags:['corporate'] },
  { id:'mini-stuffed', name:'Mini Stuffed Date Packs', pricing:'₹350', size:'100–150g pack', position:'Nut-filled, protein-rich on-the-go snack', img:'DD_4.jpeg', tags:['festivals','corporate','wedding'] },
  { id:'date-nut-spread', name:'Date & Nut Spread Jam', pricing:'₹500', size:'200g jar', position:'Healthy choco alternative', img:'DD_5.png', tags:['corporate'] },
  { id:'date-syrup', name:'Date Syrup', pricing:'₹499', size:'250ml / 500ml bottle', position:'Natural sweetener, no refined sugar', img:'DD_6.png', tags:['festivals'] },
  { id:'medjool-safawi-pack', name:'Medjool / Safawi Dates Pack', pricing:'₹1200', size:'500g / 1kg pack', position:'Premium whole dates for health & lifestyle', img:'DD_7.png', tags:['festivals','wedding'] },
];
    ...
    <article class="card">
      ...
      <div class="card-body">
        ...
        <div class="card-actions">
          <button class="btn btn-ghost" onclick="addToCart('${p.id}')">Add to Cart</button>
